...
export const SOCKET_GAME_COMMAND_ENEMY = "SOCKET_GAME_COMMAND_ENEMY";
export const SOCKET_GAME_CREATE_NEW_GAME = "SOCKET_GAME_CREATE_NEW_GAME";
export const SOCKET_GAME_NEW_GAME_CREATED = "SOCKET_GAME_NEW_GAME_CREATED";
export const SOCKET_GAME_USER_CONNECTED = "SOCKET_GAME_USER_CONNECTED";
